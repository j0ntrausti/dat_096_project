...
testvector = transpose(xlsread('sim_out_11_6M','D:D'));
sim_out_b0_r = transpose(xlsread('sim_out_11_6M','F:F')); %real part of block 0 from sim
sim_out_b0_i = transpose(xlsread('sim_out_11_6M','E:E')); %imag part of block 0 from sim
sim_out_b0_dec_r = transpose(xlsread('sim_out_11_250k','F:F')); %real part of block 0 dec from sim
sim_out_b0_dec_i = transpose(xlsread('sim_out_11_250k','E:E')); %imag part of block 0 dec from sim
sim_out_ch5_r = transpose(xlsread('sim_out_11_250k','H:H')); %real part of channel 5 in block 0 from sim
sim_out_ch5_i = transpose(xlsread('sim_out_11_250k','G:G')); %real part of channel 5 in block 0 from sim
