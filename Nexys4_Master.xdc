...
#set_property PACKAGE_PIN U9 [get_ports {data[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {data[0]}]
##Bank = 34, Pin name = IO_25_34,							Sch name = SW1
#set_property PACKAGE_PIN U8 [get_ports {data[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {data[1]}]
##Bank = 34, Pin name = IO_L23P_T3_34,						Sch name = SW2
#set_property PACKAGE_PIN R7 [get_ports {data[2]}]					
...
#set_property PACKAGE_PIN V7 [get_ports {data[5]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {data[5]}]
##Bank = 34, Pin name = IO_L20N_T3_34,						Sch name = SW6
#set_property PACKAGE_PIN V6 [get_ports {data[6]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {data[6]}]
##Bank = 34, Pin name = IO_L10P_T1_34,						Sch name = SW7
#set_property PACKAGE_PIN V5 [get_ports {data[7]}]					
...
##Bank = 15, Pin name = IO_L14P_T2_SRCC_15,					Sch name = BTNUSW
...
#set_property PACKAGE_PIN E7 [get_ports {data_serial}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {data_serial}]
...
set_property PACKAGE_PIN C4 [get_ports data_serial]						
	set_property IOSTANDARD LVCMOS33 [get_ports data_serial]
###Bank = 35, Pin name = IO_L11N_T1_SRCC_35,					Sch name = UART_RXD_OUT
#set_property PACKAGE_PIN D4 [get_ports data_serial]						
#	set_property IOSTANDARD LVCMOS33 [get_ports data_serial]
